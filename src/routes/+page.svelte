<script lang="ts">
	...
	import { currentChannelId, currentChannelConfig, setChannelById, channelConfigs } from '$lib/stores/channelStore';
	...
	// Initialize channel from URL parameter if present
	onMount(() => {
		// Check if URL has a channel ID in the path
